...
@pytest.mark.parametrize("data", [SIMPLIFIED_ALBUM_FILE_NAME], indirect=True)
def test_simplified_album_available_markets_non_empty(data):
    assert_non_empty_list_field(SIMPLIFIED_ALBUM_TYPE, data, "available_markets")
    
@pytest.mark.parametrize("data", [SIMPLIFIED_ALBUM_FILE_NAME], indirect=True)
def test_simplified_album_available_markets_field(data):
...
@pytest.mark.parametrize("data", [SIMPLIFIED_ALBUM_FILE_NAME], indirect=True)
def test_simplified_album_id_field(data):
    model_cls = SIMPLIFIED_ALBUM_TYPE
    field = "id"
